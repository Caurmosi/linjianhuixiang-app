...
_REGION_PARAMS = [
    {
        ...
        "species": [("白头鹎", 0.88), ("乌鸫", 0.84), ("麻雀", 0.90), ("珠颈斑鸠", 0.77),
                    ("暗绿绣眼鸟", 0.68), ("家燕", 0.74), ("大杜鹃", 0.61), ("黑尾蜡嘴雀", 0.66)],
    },
    {
        "name": "曲院风荷", "lat": 30.2603, "lng": 120.1369,
        "base": 69, "trend_per_week": 1.2, "weekend_penalty": -2,
        "noise_base": 32, "noise_weekend": 6,
        "species": [("黑枕黄鹂", 0.78), ("红嘴蓝鹊", 0.66), ("白鹭", 0.80), ("夜鹭", 0.74),
                    ("白头鹎", 0.85), ("普通翠鸟", 0.62), ("黑短脚鹎", 0.71), ("黄眉柳莺", 0.64)],
    },
    {
        "name": "茅家埠", "lat": 30.2396, "lng": 120.1298,
        "base": 77, "trend_per_week": 0.8, "weekend_penalty": -1,
        "noise_base": 19, "noise_weekend": 4,
        "species": [("红嘴蓝鹊", 0.81), ("领雀嘴鹎", 0.76), ("灰头绿啄木鸟", 0.68), ("斑嘴鸭", 0.74),
                    ("白胸翡翠", 0.63), ("黑短脚鹎", 0.70), ("发冠卷尾", 0.60), ("星头啄木鸟", 0.58)],
    },
]
